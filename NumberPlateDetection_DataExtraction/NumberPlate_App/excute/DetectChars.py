...
def loadKNNDataAndTrainKNN():
    ...
    try:
        npaClassifications = np.loadtxt('settings.file1', np.float32)                  # read in training classifications
    ...
    try:
        npaFlattenedImages = np.loadtxt('settings.file2', np.float32)                 # read in training images
    except:                                                                                 # if file could not be opened
